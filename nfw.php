...
class NFW {
    ...
    public static function run($cfg = null) {
        ...
        NFW::i()->stop('Controller not found');
    }
    ...
    function setLanguage($language = false) {
        ...
        } else if (isset($this->cfg['set_language_by_cookie']) && $this->cfg['set_language_by_cookie'] && isset($_COOKIE[$lang_cookie]) && in_array($_COOKIE[$lang_cookie], $this->cfg['available_languages'])) {
