...
// +----------------------------------------------------------------------+
//
// $Id: Zip.php,v 1.1 2007/11/05 16:53:46 nyuk Exp $
...
//      if (substr($p_filename, 0, strlen($p_remove_dir)) == $p_remove_dir)
  ...
  */
  ...
  {
    $v_result=1;
    $v_header=''; // Added bu nyuk (variable initialization)
  ...
  */
  ...
  {
    $v_result=1;
    $v_string=''; // Added by nyuk (variable initialization)
  ...
  */
  ...
  {
    $v_result=1;
    $v_header_list=array(); // Added by nyuk (variable initialization)
